  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark"style=" font-size:21px" >
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="color: ;">
      <ul class="navbar-nav ml-auto" >
        ...
        <li class="nav-item">
          <a class="nav-link" href="./demo/newlog.php">Login</a>  
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./demo/singup.php">sing</a>  
            </li>
    ...
    <!-- <section style="margin-top: 190px;">
      ...
      <section>
        ...
        <div class="row">
         ...
         <a href="elc.php">  <img src="man-husband-cleaning-house-helping-his-wife_85869-8314.jpg" class="img-fluid rounded-circle  d-block mx-auto" style="height: 200px; width:200px"><br><span class="">Home Electronics Repairs</span> </a>
          </div>
         <div class="col-md-4" style="text-align: center;">
         <a href="tap.php"><img src="man-husband-cleaning-house-helping-his-wife_85869-8314.jpg" class="img-fluid rounded-circle  d-block mx-auto" style="height: 200px; width:200px"><br><span class="">Plumbing</span> </a>
           </div>
           <div class="col-md-4" style="text-align: center;">
           <a href="disin.php">  <img src="man-husband-cleaning-house-helping-his-wife_85869-8314.jpg" class="img-fluid rounded-circle  d-block mx-auto" style="height: 200px; width:200px"><br><span class="">Disnfection</span> </a>
           </div>
        ...
        <div class="row">
          ...
          <a href="home.php"><img src="man-husband-cleaning-house-helping-his-wife_85869-8314.jpg" class="img-fluid rounded-circle  d-block mx-auto" style="height: 200px; width:200px"><br><span class="text-align:center">Home-Cleaning</span> </a>
           ...
           <div class="col-md-4 "style="text-align: center;">
           <a href="paint.php"> <img src="man-husband-cleaning-house-helping-his-wife_85869-8314.jpg" class="img-fluid rounded-circle  d-block mx-auto" style="height: 200px; width:200px"><br><span class="">Painting</span> </a>
           </div>
           <div class="col-md-4" style="text-align: center;">
            <a href="wood.php"><img src="man-husband-cleaning-house-helping-his-wife_85869-8314.jpg" class="img-fluid rounded-circle  d-block mx-auto" style="height: 200px; width:200px"><br><span class="">Carpentry</span> </a>
           </div>
            <!-- <div class="col-sm ">
