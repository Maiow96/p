...
<div style="margin-top: 400px;">
  ...
  <ul class="list-group">
    <li class="list-group-item d-flex justify-content-between align-items-center">
      Services
        <span class="badge badge-primary badge-pill">Charges</span>
      </li>
    <li class="list-group-item d-flex justify-content-between align-items-center">
    wooden furnitures
      <span class="badge badge-primary badge-pill">on-visit</span>
    </li>
    <!-- <li class="list-group-item d-flex justify-content-between align-items-center">
    Full-2bhk-Flat-Paint
      <span class="badge badge-primary badge-pill">Rs-122</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center">
      Full-3bhk-flat-Paint
      <span class="badge badge-primary badge-pill">1</span>
      <li class="list-group-item d-flex justify-content-between align-items-center">
         Full-house-outside-paint
        <span class="badge badge-primary badge-pill">After inspection</span>
        <li class="list-group-item d-flex justify-content-between align-items-center">
           other small 
...
<div class="col-sm-6" style="margin-left:; text-align: justify ; ">           
  ...
  <p style="text-align: justify; font-style:oblique;">
    Get fast and efficient repair services right at your doorstep with our carpentry services in your location, India. Our team of skilled carpenters will arrive at your location to provide you with top-notch repair services.
    ...
    <div class="container d-block mx-auto"  >
     <a href="buynownew.php?id=4" ><button type="button" class=" fixed-bottom btn-danger mx-auto d-block" style="width: 25%; height: 6%; border-radius: 20px;">explore</button></a>
    </div>
